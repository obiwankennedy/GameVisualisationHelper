...
Item {
    ...
    component BlurItem : ShaderEffect {
        property vector2d offset: Qt.vector2d((2.486) / width,
                                              (2.486) / height)
        visible: true
        layer.enabled: true
        layer.smooth: true
        vertexShader: "qrc:/qml/bluritem.vert.qsb"
        fragmentShader: "qrc:/qml/bluritem.frag.qsb"
    }
    ...
    BlurItem {
        ...
        property Item src: priv.useBlurItem1 ? rootItem.source : null
